    ...
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        ...
        <Dialog open={selectedImageIndex !== null} onOpenChange={() => setSelectedImageIndex(null)}>
          <DialogContent className="max-w-3xl w-[50vw] h-[50vh] p-0 bg-background/95 backdrop-blur-sm border-border/50 top-[50px] translate-y-0">
                    ...
                    <div className="flex gap-1.5 overflow-x-auto pb-1 scrollbar-thin scrollbar-thumb-primary scrollbar-track-muted">
                      {imageSlots.map((slot, index) => (
                        ...
                        >
                          ...
                          <div className="absolute bottom-0 left-0 right-0 bg-background/80 backdrop-blur-sm text-center h-[10px] flex items-center justify-center">
                            <span className="text-[8px] font-medium leading-none">#{index + 1}</span>
                          </div>
                        </button>
                      ))}
                    </div>

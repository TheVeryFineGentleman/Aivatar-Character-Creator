...
const PLANS = [
  {
    ...
    link: null,
    features: [
      { text: "Hochwertige Avatar-Bilder generieren", bold: false },
      { text: "Flexible Aufnahme-Typen: Ganzkörper, Oberkörper, Nahaufnahme", bold: true },
      { text: "Professionelle Hintergründe inkl. Green Screen", bold: true },
      { text: "Alle gängigen Bildformate: 1:1, 9:16, 16:9, 21:9", bold: false },
      { text: "Schritt für Schritt Anleitung", bold: false },
    ],
  },
  {
    id: "PREMIUM",
    ...
    features: [
      ...
      { text: "Szenerien & Umgebungen frei wählbar", bold: true },
      { text: "Mehrere Referenzbilder zur exakten Steuerung", bold: false },
      { text: "Custom Prompt Funktion (eigene Texte & Prompts)", bold: true },
      { text: "Professionelle Hintergründe nach Wunsch", bold: false },
    ],
  },
  {
    id: "FULL",
    ...
    features: [
      ...
      { text: "KI Dialoge & Sprechertexte + Feintuning", bold: true, indent: true },
      { text: "Automatischer Videoschnitt ohne Bearbeitung", bold: false },
      { text: "Flexible Video-Export-Optionen inklusive", bold: true },
      { text: "Maximale KI-Unterstützung für Reels & Storys", bold: false },
      { text: "Export für externe Tools (Veo3 uvm.)", bold: false },
    ],
  },
];

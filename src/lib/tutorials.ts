...
import { KeyRound, Sparkles, Users, LayoutGrid, Wand2, Camera, Film } from "lucide-react";
...
export const TUTORIALS: Tutorial[] = [
  ...
  { id: "quick", num: "03", title: "Quick Creator",   subtitle: "Schnell einen Charakter erstellen",       category: "character", planFlag: "quickCreator",   nav: { kind: "character", mode: "quick" }, color: "hsl(263 70% 70%)", Icon: Sparkles },
  { id: "chat",  num: "04", title: "Chat Creator",    subtitle: "Charakter im Dialog entwickeln",          category: "character", planFlag: "chatCreator",    nav: { kind: "character", mode: "chat" },  color: "hsl(270 60% 72%)", Icon: Users },
  { id: "views", num: "05", title: "Character Views",  subtitle: "Mehrere Ansichten generieren",            category: "character", planFlag: "characterViews", nav: { kind: "character", mode: "views" }, color: "hsl(188 94% 60%)", Icon: LayoutGrid },
  { id: "poses", num: "06", title: "Pose Grid",        subtitle: "Posen-Raster erzeugen",                   category: "character", planFlag: "poseGrid",       nav: { kind: "character", mode: "poses" }, color: "hsl(160 70% 55%)", Icon: LayoutGrid },
  { id: "remix", num: "07", title: "Smart Remix",      subtitle: "Bestehende Bilder neu interpretieren",    category: "character", planFlag: "smartRemix",     nav: { kind: "character", mode: "remix" }, color: "hsl(330 82% 64%)", Icon: Wand2 },
  { id: "studio", num: "08", title: "Avatar Studio",   subtitle: "Perfekte Shots aus einem Referenzbild",   category: "studio", planFlag: "avatarStudio", nav: { kind: "route", to: "/studio" }, color: "hsl(28 95% 60%)", Icon: Camera },
  { id: "story",  num: "09", title: "Reel / Story",    subtitle: "Storyboards & Veo-Videos erstellen",      category: "story",  planFlag: "storyReel",    nav: { kind: "route", to: "/story" },  color: "hsl(38 92% 60%)", Icon: Film },
];
